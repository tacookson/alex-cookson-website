...
<p align = "center">
![shapefile example](/post/2020-06-17-rating-childrens-books-with-empirical-bayes-estimation_files/movie-reviews-normal.png){width=600px}
</p>  
\  
...
<p align = "center">
![shapefile example](/post/2020-06-17-rating-childrens-books-with-empirical-bayes-estimation_files/movie-reviews-actual.png){width=600px}
</p>  
\  
...
We've successfully used empirical Bayes estimation to get more reasonable ratings for our 9,000 children's books! If you'd like to see the full dataset of adjusted ratings, feel free to download it [here](https://raw.githubusercontent.com/tacookson/data/master/childrens-book-ratings/childrens-books-empirical-bayes-ratings.txt) (file is a .txt file with tab-separated values formatting). And, if you're keen to see more adjustments of these ratings, stay tuned for a post where I will **normalize and re-scale** the ratings.
