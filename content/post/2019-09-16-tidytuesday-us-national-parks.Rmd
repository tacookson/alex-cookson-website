---
title: 'TidyTuesday: US national parks'
author: Alex Cookson
date: '2019-09-16'
...
In addition to visitor figures, TidyTuesday also has state population data. This will be useful if we want to look at the relationship between park visitors and population (spoiler: we do exactly this).
